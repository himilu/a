...
$__version__  = '3.1.2';
$__password__ = '511'; //Á¬½ÓÃÜÂë£¬ÀýÈç£º$__password__ = 'gunduzi';
$__hostsdeny__ = array(); // ½ûÖ¹·ÃÎÊµÄÍøÕ¾£¬ÀýÈç£º$__hostsdeny__ = array('.youtube.com', '.youku.com');
...
function get() {
    ...
    if ($host && $host != $domain && $host != 'www'.$domain) {
        header('Location: https://www.crosscngfw.ml'); //Ìø×ªÍøÖ·
    } else {
        header('Location: https://www.crosscngfw.ml'); //Ìø×ªÍøÖ·
    }
}
